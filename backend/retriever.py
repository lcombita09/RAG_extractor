...
def build_vectorstore(embeddings_model, pdf_file_name: str) -> FAISS:
    """
...
def load_vectorstore(embeddings_model, pdf_file_path: str) -> FAISS:
    """
...
def extract_top_documents(vectorstore: FAISS, prompt_request: str, top_k: int, fetch_k: int) -> List[str]:
    """
...
def load_retriever_queries() -> dict:
    """
